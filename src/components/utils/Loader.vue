...
<style scoped>
  ...
  .loader-text {
    ...
    font-size: 30px;
    clip-path: inset(0 2.8ch 0 0);
    animation: l4 1s steps(6) infinite;
...
@keyframes bounce2 {
  ...
  @keyframes l4 {to{clip-path: inset(0 -2ch 0 0)}}
