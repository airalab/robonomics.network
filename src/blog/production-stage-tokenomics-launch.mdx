...
Today, 100+ sensors contribute to an open environmental dataset running on web3 infrastructure. You can see all the data on the map at <a href="https://sensors.social/" target="_blank" rel="noopener noreferrer"><strong>sensors.social</strong></a>. We invite you to join the Altruism movement: get a sensor, install it on your balcony, and start contributing. Or grab the **Altruist Dual** to capture both indoor and outdoor data.
