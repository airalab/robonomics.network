---
title: "Update auf Version 1.2: Staking, Technischer Ausschuss und Schatzkammer"
date: 2021-09-17
published: true
locale: 'de'
...
description: "Die Projektentwickler haben zwei wichtige Änderungen im Betrieb der Robonomics-Parachain implementiert. Die erste ist die Einführung von XRT-Staking, und die zweite ist der Start der ersten On-Chain-Governance-Mechanismen."
abstract: "Die Projektentwickler haben zwei wichtige Änderungen im Betrieb der Robonomics-Parachain implementiert. Die erste ist die Einführung von XRT-Staking, und die zweite ist der Start der ersten On-Chain-Governance-Mechanismen."
...
Ich werde in einem separaten Artikel mit dem Titel „Automatisierte Abonnement-Auktion“ darüber schreiben, wie die Abonnements und der Zahlungspool verteilt werden.
...
Nach dem 1.3 RWS-Update wird der Staking-Mechanismus im Netzwerk live geschaltet. Das RWS-Update wird die Abonnementfähigkeit für digitale Zwillinge hinzufügen, und die Herausforderung der Bandbreitenzuweisung wird relevant. Dementsprechend werden wir später die Korrektheit des Staking-Mechanismus vollständig bewerten können.

## Update 1.2: Tech Committee und Treasury
...
Seit dem 15. September sind die sechs Mitglieder des technischen Komitees sichtbar, die hinzugefügt wurden: 2 DevOps-Spezialisten, ein Softwarearchitekt, der Hauptentwickler der Substrate-Implementierung, ein leitender Robotikingenieur und ein leitender DApp-Entwickler.
...
Im vergangenen Monat wurden etwa 100.000 XRT aus der Treasury an die Guthaben der Teilnehmer der ersten Robonomics-Crowdloan-Kampagne aus dem Sommer 2021 verteilt. Diese Vorgänge werden nicht als Anträge angezeigt, sondern von Sudo durchgeführt. Jetzt, da wir ein technisches Komitee haben, werden Anträge per Abstimmung entschieden.
...
Bleiben Sie dran und verfolgen Sie Updates
