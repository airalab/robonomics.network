...
cover_image: /blog/images/robonomics-production-stage-tokenomics-launch/cover.jpg
...
<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/cyberpunks-shop-homepage.jpg" alt="cyberpunks.shop homepage — open-source web3 hardware store featuring the Altruist sensor" caption="cyberpunks.shop — where Altruist and other open-source web3 hardware is sold" />
...
<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/amazon-seller-verified.png" alt="Amazon seller-account verification notice: 'Your information is verified – Start selling on Amazon now'" caption="Amazon seller verification, just confirmed — Altruist hits Amazon EU in the coming weeks." />
...
<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/robonomics.network-digital-freedom-16-9.jpg" alt="Cyberpunk attic scene — a hacker's room at night with 'Freedom Resistance' graffiti glowing on the wall, screens lit, a person stretching toward the light" />
...
<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/remote-cloud-access.jpg" alt="Mockup — a laptop screen running the Robonomics dashboard with live Home Assistant Core, Altruist sensor readings, and IPFS / libp2p status, next to a phone screen showing the XRT cloud-subscription renewal UI on the Polkadot network." caption="After activating an XRT subscription, users get remote access to their smart home, smart devices — and, in the future, robots — from anywhere in the world over peer-to-peer web3 infrastructure, with no centralized corporate cloud in the loop." />
...
<RbImage zoom style="max-width: 60%" src="/blog/images/robonomics-production-stage-tokenomics-launch/subscription-activated.png" alt="Robonomics cloud subscription activation UI on Polkadot — account Ens-Snail-On-The-slope, network Polkadot, current subscription valid until 24.06.2026, balance 4999.4175 XRT, subscription price 1 XRT, activation time ~2 min, 29 available subscriptions, with a green 'SUBSCRIPTION ACTIVATED' confirmation." caption="A real Robonomics cloud subscription, activated on Polkadot at 1 XRT — the price every device owner pays is the price XRT traders set on the open market." />

## XRT Migration from R&D Stage to Production Chain on Polkadot

<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/robonomics-evolution.png" alt="Robonomics evolution over 11 years — AIRA (2015, R&D Stage 1), Robonomics (2021, R&D Stage 2), Production (2026)" caption="11 years of Robonomics evolution — from AIRA R&D to the production stage" />
...
<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/tokenomics-infographic.png" alt="Robonomics production-stage tokenomics infographic" caption="Robonomics production-stage tokenomics — full overview" />
...
<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/xrt-price-2025.png" alt="XRT to USD price chart over 2025" caption="XRT/USD price over 2025 (range $0.90 – $5.50)" />
...
<RbImage zoom src="/blog/images/robonomics-production-stage-tokenomics-launch/cyberpunks-hardware-vignette.png" alt="A quiet evening scene — a meditation corner in the foreground, with the CYBERPUNKS HARDWARE logo on a sunlit wall and the silhouette of a person in a tree pose" />
