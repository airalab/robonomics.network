...
*Uma tarefa interessante para a comunidade:* verificar a correção do calculador de recompensas, levando em conta as duas opções: uma recompensa anual de 10% para participantes da migração Exodus e uma recompensa anual de 50% para membros da campanha de crowd loan.
...
O portal do comitê técnico está disponível em: https://parachain.robonomics.network/?rpc=wss%3A%2---
locale: pt
---
...
A partir de 15 de setembro, você pode ver os seis membros do comitê técnico que foram adicionados: 2 especialistas em devops, um arquiteto de software, o principal desenvolvedor de implementação Substrate, um engenheiro sênior de robótica e um desenvolvedor sênior de DApp.
...
Você pode ler mais sobre o trabalho deste comitê na wiki da Polkadot: https://wiki.polkadot.network/docs/learn-governance#technical-committee
...
No último mês, cerca de 100 mil XRT foram distribuídos da tesouraria para os saldos dos participantes da primeira campanha de crowd loan da Robonomics do verão de 2021. Essas operações não são mostradas como solicitações, mas sim feitas por Sudo. Agora que temos um comitê técnico, as solicitações passarão por votação.

Também vale destacar um mecanismo interessante da tesouraria: a queima periódica de saldos. Você pode ler mais sobre o funcionamento da tesouraria na wiki da Polkadot: https://wiki.polkadot.network/docs/learn-treasury
