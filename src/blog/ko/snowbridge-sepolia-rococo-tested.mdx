...
안녕하세요, 여러분. 아시다시피 Robonomics 프로젝트는 Ethereum과 Kusama 두 네트워크에서 동시에 운영되고 있습니다. 현재 이 두 네트워크 간에 XRT 토큰을 전송할 방법이 없습니다. 그래서 저희는 Ethereum과 Polkadot 간의 범용 브릿지로 개발 중인 Snowbridge 프로젝트를 주의 깊게 지켜보고 있습니다: https://docs.snowbridge.network/
...
1. 먼저, 브릿지 컨트랙트가 해당 계정에서 15 XRT를 사용할 수 있도록 허용했습니다: 
...
마지막 단계는 Rococo Asset Hub에서 Sepolia로 XRT를 다시 보내는 것이었습니다. Rococo Asset Hub에서 다음 extrinsic을 실행했습니다:

https://polkadot.js.org/apps/?rpc=wss%3A%2F이 트랜잭션은 Rococo Asset Hub 블록 탐색기에서 확인할 수 있습니다:
