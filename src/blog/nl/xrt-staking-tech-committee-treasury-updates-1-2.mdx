...
Parachains hebben geen staking nodig in hun kernfunctionaliteit. Parachains worden beveiligd door Relay Chain validators. Dit is een gedeeld beveiligingsmodel waarbij projecten strijden om slots tijdens veilingen.
...
Op de Exodus DApp-interface kun je de migratiestatistieken van de Ethereum-blockchain naar de Robonomics-parachain zien: https://robonomics.app/#/exodus
...
De huidige taak voor de ontwikkelaars is het testen van de basis stakingmechanismen voor tokenhouders onder reële omstandigheden: toevoegen aan de stakingpool, beloningen verzamelen en tokens binnen 7 dagen deblokkeren.
...
## Update 1.2: Technische Commissie en Schatkist

Net als bij update 1.1 is dit al geïmplementeerd in het parachain-werk. De technische commissie bestaat momenteel uit zes technische specialisten die de afgelopen 2 jaar hebben deelgenomen aan de ontwikkeling van de parachain; de DAO [heeft 692.500 XRT overgedragen](https://etherscan.io/tx/0x6b9a9cbe7d21badf565ebce0fb50b865da8f5f784899db5fb455d1b276d14acf) naar het saldo van de schatkist van de parachain door ERC-20-tokens te verbranden via de Exodus DApp. De schatkist en de technische commissie van het netwerk zijn de eerste elementen van on-chain governance die de parachain-ontwikkelaars tot nu toe hebben geïmplementeerd. Meer details over elk van hen worden hieronder gegeven.

### Technische Commissie van het Netwerk

Het portaal van de technische commissie is beschikbaar op: https://parachain.robonomics.network/?rpc=wss%3A%2---
locale: nl
---

F%2Fmain.frontier.rpc.robonomics.network%2F#/techcomm

![Het technische commissieportaal in de Robonomics parachain](/blog/images/xrt-staking-tech-committee-treasury-updates-1-2/image5.jpg)

Vanaf 15 september kun je de zes leden van de technische commissie zien die zijn toegevoegd: 2 devops specialisten, een softwarearchitect, de hoofdontwikkelaar van de Substrate-implementatie, een senior robotica-ingenieur en een senior DApp-ontwikkelaar.
De technische commissie zal zich bezighouden met het updaten van de parachain runtime code, te beginnen met volgende releases op GitHub.

Je kunt meer lezen over het werk van deze commissie in de Polkadot wiki: https://wiki.polkadot.network/docs/learn-governance#technical-committee
...
In de afgelopen maand is er ongeveer 100k XRT uit de schatkist verdeeld naar de saldi van deelnemers aan de eerste Robonomics crowd loan campagne van zomer 2021. Deze operaties worden niet weergegeven als verzoeken, maar zijn uitgevoerd door Sudo. Nu we een technische commissie hebben, zullen verzoeken via een stemming verlopen.
...
Er komen veel spannende updates aan, en elk zal nieuwe kansen openen voor de gemeenschap. Updates van het community development programma van het project worden binnenkort gepubliceerd met meer informatie over wat er beschikbaar zal zijn voor de gemeenschap over dede komende 6 maanden.
