...
جوهر شبكة Robonomics هو عقد [Liability](https://github.com/airalab/robonomics_contracts/blob/master/contracts/robonomics/Liability.sol)، وهو عقد ذكي يعيد إنتاج العلاقة النموذجية بين طالب الخدمة (الموعود له) ومقدم الخدمة (الموعود)، ويتضمن المعايير التقنية والاقتصادية للمعاملة بينهما. يمكن أن يكون الطرفان إما وكيلاً ذاتياً وشخصاً (تفاعل إنسان-آلة)، أو وكيلين ذاتيين بالكامل (تفاعل آلة-آلة). يقوم الموعود له والموعود ببث رسائل تحتوي على معايير معاملتهم التقنية-الاقتصادية، ثم يتم إتمام المعاملة من خلال عقد خاص - المزود - الذي يبحث عن تطابق هذه المعايير. يتم التحكم في المزودين بواسطة [Lighthouse](https://github.com/airalab/robonomics_contracts/blob/master/contracts/robonomics/Lighthouse.sol)، وهو عقد ذكي خاص ينفذ المعاملة عندما يحقق المزود تطابقًا في السوق بين الأطراف.

هناك ثلاثة سيناريوهات يمكن من خلالها تنفيذ الالتزام:

1. التزام بسيط (دون التحقق من النتيجة النهائية، ودون دفع عمولة لعقدة المزود)
...
لمعرفة المزيد عن حالات الاستخدام الممكنة لروبونوميكس، اطلع على صفحة [البحث والتطوير](https://wiki.robonomics.network/docs/en/r-and-d-based-on-robonomics-network/#launching-a-drone-under-the-control-of-a-decentralized-computer) الخاصة بروبونوميكس!

لإعادة بناء البنية التحتية الكاملة لروبونوميكس على شبكة Neon، سننفذ سيناريو إطلاق روبوت من خلال عقد الالتزام مماثل لهذا [المثال](https://wiki.robonomics.network/docs/en/kuka/). إذا كان من الممكن تكرار السكريبت، فستعمل جميع الوظائف.
...
[شفرة المصدر](https://github.com/Multi-Agent-io/neon-kuka-demo) للسيناريو
...
بعد ذلك، يجد الـ Promisor عقد مسؤولية جديد في الشبكة ويبدأ في تنفيذه. عند الانتهاء من العمل، يتم إرسال رسالة بالنتيجة، والتي يتم تسجيلها بعد ذلك في العقد.
...
عند بدء المحاكاة، يتم إنشاء رسالة عرض، وتأتي رسالة طلب من الـ Promisee، وبعد ذلك يتم إنشاء عقد مسؤولية باستخدام دالة createLiability من عقد Lighthouse. بمساعدة عقد XRT، يتم نقل الرموز من عنوان الـ Promisee إلى عنوان عقد المسؤولية.

بعد اكتشاف عقد مسؤولية جديد على شبكة Neon devnet، يبدأ الوكيل في العمل. يتم كتابة نتيجة العمل (القياسات عن بعد) إلى ملف وإرساله إلى IPFS، ويتم حفظ الهاش من الملف كنتيجة.

بعد الانتهاء من العمل، يتم إنهاء عقد المسؤولية باستخدام دالة finalizeLiability() من عقد Lighthouse ويتم نقل الرموز من عنوان المسؤولية إلى عناوين الـ Promisor و Validator.
...
باستخدام منصة Neon EVM، تم اختبار سيناريو بنجاح حيث تم إبرام عقد مسؤولية بين الموعود له والموعود، مع التحقق اللاحق من نتيجة العمل المنجز من قبل طرف ثالث. بالإضافة إلى ذلك، شارك مزود خدمة قام بالتحقق من تطابق العرض والطلب بين الأطراف، وتلقى عمولة مقابل هذا العمل.
