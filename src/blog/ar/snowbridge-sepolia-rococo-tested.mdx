...
abstract: "Snowbridge هو جسر عام، غير موثوق ولا مركزي بين Polkadot و Ethereum."
...
بعد نجاح التسجيل، تلقينا الاستجابة التالية:
```
{
...
DB62573380CfEf#writeContract
    <RbImage zoom src="/blog/images/snowbridge-sepolia-rococo-tested/xrt_approve_snowbridge_as_spender.png" alt="الموافقة على XRT كمُنفق" />
...
3. تم بدء تحويل XRT من Sepolia إلى Rococo Asset Hub باتباع تعليمات Snowbridge باستخدام مثال WETH: https://docs.snowbridge.network/rococo-testnet/rococo-sepolia-token-transfers#id-5.-send-weth-to-polkadot
    ...
    ملاحظة هامة بخصوص حقل `destinationAddress.data`: كان يجب أن تكون قيمته محاطة بعلامات اقتباس (مثال: "0xb0fca9a0c5e03ab5b2294784fbbabea010295b3e1e48575cfe18dc2172ef657d").
...
تم إكمال هذه الخطوة بسرعة نسبياً، خلال نصف ساعة تقريباً. ونتيجة لذلك، تم تحويل 1 XRT مرة أخرى إلى Sepolia. بقي رصيد XRT في Rococo Asset Hub عند 14 XRT:
