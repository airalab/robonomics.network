<template>
  ...
  >
    ...
    <section class="case-page__content hyphens">
      ...
      <!-- decor image -->
      <g-image class="decor-img-1" aria-hidden="true" src="@/assets/images/cases/blockchain-coffee/coffee-decor-1.png"/>
      <g-image class="decor-img-2" aria-hidden="true" src="@/assets/images/cases/blockchain-coffee/coffee-decor-2.png"/>
      <g-image class="decor-img-3" aria-hidden="true" src="@/assets/images/cases/blockchain-coffee/coffee-decor-3.png"/>
    </section>
  </CaseLayout>
</template>
