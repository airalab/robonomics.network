      ...
      <div class="layout layout__content">
        ...
        <span class="privacy-policy__updated block mb-space text-center highlight-green"><em>{{ $t('Last updated: February 03, 2025') }}</em></span>
          ...
          <div class="privacy-policy__wrapper">
            ...
            <ul>
              <li>
                <strong>{{$t('DAO')}}</strong> {{ $t('(referred to as either "the DAO", "We", "Us" or "Our" in this Agreement) refers to decentralized autonomous organization Robonomics Network, an operator for website')}} <g-link to="/">robonomics.network </g-link> {{$t('(“Website”)') }}.
                <p class="privacy-policy__descr">{{$t('For the purpose of the GDPR, the DAO is the Data Controller.')}}</p>
              </li>
              ...
              <li>
                <strong>{{ $t('You') }}</strong> {{ $t('means the individual accessing or using the Service, or the DAO, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.') }}
          ...
          <div class="privacy-policy__wrapper">
            ...
            <ul>
              ...
              <li><strong>{{ $t('For business transfers') }}</strong>: {{ $t('We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of DAO assets, financing, or acquisition of all or a portion of Our business to another DAO.') }}</li>
          ...
          <!-- <h3 class="privacy-policy__subtitle">{{ $t('Right Ro Rectification Or Erasure') }}</h3>
          <p class="privacy-policy__descr">
            {{ $t("You have the right to obtain from the DAO, without undue delay, the rectification of inaccurate personal data concerning You.") }}
          </p>
          <p class="privacy-policy__descr">{{ $t('You have the right to obtain from the DAO the erasure of personal data concerning you as soon as possible, and the DAO shall have the obligation to erase personal data.') }}</p>
          <p class="privacy-policy__descr">{{ $t('If you wish to exercise this right to rectification or to erasure, you may, at any time, contact the DAO as stated in section “Contact us” of this Privacy Policy.') }}</p> -->
