<template>
  <layout-inside>
    ...
    <section class="layout__content layout__text">
      <tabs>
          <tab name="Intro" class="layout__content">
            ...
            <p class="hyphens"><strong>If you have no idea</strong>, what is Robonomics, go to our <g-link to="https://wiki.robonomics.network/">Wiki</g-link>, read docs from tabs 'DOCS' and 'SCIENCE', chat with us (all links in tab 'INTOUCH').</p>
          </tab>

          <tab name="Assets" class="layout__content">
            <share :assets="assets"/>
          </tab>
          <tab name="Docs" class="layout__content">
              <ul>
                <li>Book</li>
                <li>Book</li>
              </ul>
          </tab>
          <tab name="Science" class="layout__content">
              <ul>
                <li>Article</li>
                <li>Article</li>
              </ul>
          </tab>
          <tab name="Token" class="layout__content">
              some info
          </tab>
          <tab name="Intouch" class="layout__content">
              some info
          </tab>
      </tabs>
    </section>
