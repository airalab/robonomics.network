  ...
  <layout-inside>
    ...
    <section class="layout__content layout__text">
      <tabs>
          ...
          <tab name="Assets" class="layout__content layout__text">
            <share :assets="assets"/>
          </tab>
          ...
          <tab name="Token" class="layout__content layout__text">
              some info
          </tab>
          <tab name="Intouch" class="layout__content layout__text">
              some info
          </tab>
      </tabs>
    </section>
