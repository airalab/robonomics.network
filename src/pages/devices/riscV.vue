<template>
  ...
  <layout :backlink="{title: 'All hardware', link: '/devices/', label: 'Go to all hardware'}" :title="$t('RISC-V Smart Home Server')">
    ...
    <div class="layout layout__content">
      <p class="text-center"><b>BECOME THE COMPLETE SOVEREIGN OF YOUR SMART HOME</b>.</p>
      <p class="text-center">The first server for a smart home built entirely on open-source — from CPU to decentralized cloud.</p>
      ...
      <h2 class="title-lined"><span>Overview</span></h2>
      <RiscV class="risc-v-page"/>

      <section class="section">
        <div class="highlight-solid-green__wrapper">
          <h3 class="highlight-solid-green">RISC-V — Get Server with Open Architecture</h3>
        </div>
        <p>RISC-V is an open and modular processor architecture based on a reduced instruction set (RISC). Unlike proprietary solutions, it offers flexibility for customization without licensing restrictions, making it ideal for IoT devices and servers. RISC-V enables highly efficient and cost-effective designs, which translate into lower power consumption and better performance of your home server.</p>

        <details>
          <summary>Specification of server:</summary>
              <ul class="list-smallgap">
                <li><b>Processor:</b> StarFive JH-7110 with RISC-V 4-core CPU, 2 MB L2 cache, up to 1.5 GHz, RV64GC ISA support</li>
                <li><b>GPU:</b> IMG BXE-4-32 MC1, up to 600 MHz</li>
                <li><b>Memory:</b> 8 GB LPDDR4 SDRAM, up to 2800 Mbps</li>
                <li><b>Storage:</b> 32 GB TF card (minimum)</li>
                <li><b>Interfaces:</b> 2x Gigabit Ethernet ports, 4x USB 3.0 Type-A ports, 40-pin GPIO header, M.2 connector,  eMMC socket, 2-pin fan header</li>
                <li><b>Power:</b> 5V DC via USB-C, up to 30 W (minimum 3 A) or 5V input via 40-pin GPIO</li>
      ...
      <section class="section">
        <div class="highlight-solid-green__wrapper">
          <h3 class="highlight-solid-green">Home Assistant — Install Open-Source Platform for Home Automation</h3>
        </div>
        <p>Home Assistant is an open-source home automation platform designed to give users full control over their smart devices. It runs entirely locally, ensuring maximum privacy and eliminating dependence on third-party cloud services. Its core strength lies in its flexibility, enabling users to create custom integrations and automations that suit their specific needs like lighting, security, and climate control, regardless of brand.</p>
        <details>
          <summary>Features:</summary>
          <ul class="list-smallgap">
            <li><b>Local control:</b>runs entirely on local hardware</li>
            <li><b>Modular design:</b> Highly flexible, allowing users to add various components, automations and integrations</li>
            <li><b>No vendor lock-in:</b> Supports over 3000 integrations with devices from various manufacturers</li>
          </ul>
        </details>
      ...
      <section class="section">
        <div class="highlight-solid-green__wrapper">
          <h3 class="highlight-solid-green">Robonomics Integration — Integrate Corporate-Free Cloud with P2P Remote Control</h3>
        </div>
        <p>Robonomics has developed its own integration for Home Assistant, which brings all the benefits of a decentralized cloud and p2p communications to the smart home. Only you have cryptographic access to all the functions of the home and decide who will use it.</p>
        <details>
          <summary>Functions:</summary>
          <ul class="list-smallgap">
            <li>Remote access to the current device states</li>
            <li>Remote device control via parachain or Libp2p</li>
            <li>Home Assistant users management</li>
            <li>Backing up and restoring HA configuration</li>
            <li>Storing digital twin of the home in a secure decentralized cloud</li>
            <li>Secure report service for technical support providing</li>
          </ul>
        </details>
      ...
      <section class="section">
        <div class="highlight-solid-green__wrapper">
          <h3 class="highlight-solid-green">Zigbee/Wi-Fi Smart Devices — Add Thousands of Solutions for Any Needs</h3>
        </div>
...
export default {
  ...
  components: {
    ...
    RiscV: () => import("~/components/3dmodels/riscV.vue"),
  },
...
<style scoped> 
  ...
  .highlight-solid-green__wrapper .highlight-solid-green {
    display: inline
  }
